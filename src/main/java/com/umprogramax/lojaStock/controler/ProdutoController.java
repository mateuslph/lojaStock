...
public class ProdutoController {
    ...
    public String save(@ModelAttribute("produto")Produto produto) {
        ...
        return "redirect:/salvar-produto/index";
    }

    @GetMapping(value="/listar-produto")
    public String index(Model model) {
        model.addAttribute("produto", service.list());
        return "/listar-produtos/index";
    }

    @PutMapping(value="/atualizar-produtos/{id}")
    public String update(@PathVariable UUID id, @ModelAttribute("produtos") Produto produto, Model model) {
        ...
        service.update(obj);
        return "redirect:/atualizar-produto/index";
    }
